...
export default function AestheticSceneR3F(): JSX.Element {
  ...
  return (
    <div className="relative flex w-full h-screen bg-white">
      <div className="w-64 absolute left-2 top-2 p-3 bg-white border border-black space-y-4 h-fit z-20 rounded-lg ">
        <div className='flex items-center gap-2 justify-between'>
          <LuSettings2   className='w-6 h-6'/>
          {/* <h3 className='text-xl font-semibold uppercase'>Playground</h3> */}
          <Button onClick={()=>{
            setOpenSidebar(!openSideBar)
          }} icon={openSideBar ? GoChevronUp   : GoChevronDown  }  variant='grayscale' size='iconsm'> 
